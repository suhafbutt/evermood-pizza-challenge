...
ActiveRecord::Schema[8.0].define(version: 20_241_119_161_418) do
  ...
  create_table 'oder_offers', force: :cascade do |t|
    t.integer 'order_id', null: false
    t.integer 'offer_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['offer_id'], name: 'index_oder_offers_on_offer_id'
    t.index ['order_id'], name: 'index_oder_offers_on_order_id'
  end
  ...
  add_foreign_key 'oder_offers', 'offers'
  add_foreign_key 'oder_offers', 'orders'
